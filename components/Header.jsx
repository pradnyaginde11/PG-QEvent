    ...
    <nav className="drop-shadow-2xl flex items-center justify-between p-3 border-b border-slate-200 border-spacing-0 bg-slate-100 h-24">
      ...
      <div className="flex justify-center items-center gap-4">
        <div className="flex items-center justify-center gap-5 font-semibold max-md:hidden">
          ...
          {session && (
            // <Link href="/create-event" className="hover:text-primary hover:scale-105 hover:underline transition-all">
            <Link href="/create-event" className="bg-gradient-to-r from-orange-400 to-teal-600 text-white px-4 py-2 rounded-md font-medium hover:opacity-70">
              Create Event
            </Link>
          )}
